...
#folder locations 
FOLDER = '/home/pi/SDS-011-Python/AQ_run/data/' #for raw data
FOLDERCODE='/home/pi/SDS-011-Python/AQ_run/Scripts/' #For the scpirs locaton 
...
#LOC=['Tsurumi','34.715474', '135.584539'] #Add test name into this too, say aersol and calbration ...
LOC=['Home','', ''] 
