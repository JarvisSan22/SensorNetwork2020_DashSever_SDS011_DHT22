    ...
    if V.OPCON=="ON":
        for sen in SENSORS:
            ...
            if "SDS" in sen or "sds" in sen:
                columns=columns+",sds-pm2.5,sds-pm10,sds-ExtraData"  #Note: ExtraData is a extra bit of data recored by the SDS but there no information on what it actully is. If you know please let me know. 
